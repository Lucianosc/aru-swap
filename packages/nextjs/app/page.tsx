...
const Home: NextPage = () => {
  ...
  //const usdcAddress = "0x036CbD53842c5426634e7929541eC2318f3dCF7e"; // Address of the USDC contract in Base Sepolia
  ...
  const destinationDomain = 6; // Destination domain (e.g., the chain ID)
  const destinationAddress = "0x0c558b655d388f7041bc4FbfbdF02AE1a605F19B"; // Change to msg.sender

  const calldata = generateCombinedCallData(
    usdcAddress,
    cctpAddress,
    amount,
    destinationDomain,
